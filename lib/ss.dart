...
const supabaseUrl = 'https://oluxkcvmkkxyuglviyca.supabase.co';
const supabaseKey = String.fromEnvironment('SUPABASE_KEY');
Future<void> main() async {
  await dotenv.load(fileName: ".env");
  await Supabase.initialize(url: 'https://oluxkcvmkkxyuglviyca.supabase.co', anonKey: dotenv.env['SUPABASE_KEY']!);
  runApp(const MyApp());
}
